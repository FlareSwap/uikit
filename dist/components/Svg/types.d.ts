...
export declare enum icons {
    ...
    BSC_TOKEN = "bsc_token",
    FLARE_TOKEN = "flare_token",
    SONGBIRD_TOKEN = "songbird_token",
    COSTON_TOKEN = "coston_token",
    ARBITRUM_CHAIN = "arbitrum_chain",
    POLYGON_CHAIN = "polygon_chain",
    BINANCE_CHAIN = "binance_chain",
    FLARE_CHAIN = "flare_chain",
    SONGBIRD_CHAIN = "songbird_chain",
    COSTON_CHAIN = "coston_chain",
    DISCORD = "discord",
    REDDIT = "reddit",
    MEDIUM = "medium",
    INSTAGRAM = "instagram",
...
export declare type iconTypes = `${icons}`;
declare type directionTypes = `${directions}`;
